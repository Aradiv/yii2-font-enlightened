 ...
 * @link https://github.com/rmrevin/yii2-fontawesome/blob/master/component/Stack.php
...
class Stack
{
    ...
    {
        Html::addCssClass($options, FE::$cssPrefix . '-stack');
    ...
    public function __toString()
    {
        ...
        $icon_back = $this->icon_back instanceof Icon
            ? $this->icon_back->addCssClass(FE::$cssPrefix . '-stack-2x')
            : null;

        $icon_front = $this->icon_front instanceof Icon
            ? $this->icon_front->addCssClass(FE::$cssPrefix . '-stack-1x')
            : null;
